...
switch ($opc) {
    case '1':
        ?>
            ...
            <body>
                <form action="proEncar.php" method="$_GET">
    ...
    case '2':
        ...
        <body>
            <form action="proVende.php" method="post">
                <hl>Formulario de sueldo de vendedor</hl><br><br>
                <label for="">Ingrese el nombre del trabajador: </label>
                <input type="text" name="namevv"><br>
    ...
    ?>
        ...
        <body>
            <form action="proSubcont.php" method="post">
